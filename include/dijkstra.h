...
/**
 * @brief Position structure for Dijkstra's algorithm
...
/**
 * @brief Cell structure for Dijkstra's algorithm
...
/**
 * @brief Just here to make it easier to read.
 */
typedef t_list	t_queue;

/**
 * @brief Cost map structure for Dijkstra's algorithm
 * @note this is just a 2D array of t_cell.
 */
